...
// Поддержка тач-устройств: переворот по тапу для карточек в связи математики и английского
document.querySelectorAll('.connection-section .flip-card').forEach(card => {
